rule extract_needle:
    ...
    run:
        ...
        ref_end = ref_start+1
        ref_up_seq = ref_records_dict[ref_chr].seq[ref_start+1-(total_len+50):ref_start+1]
        ref_dw_seq = ref_records_dict[ref_chr].seq[ref_end:ref_end+total_len+50]
...
rule summary_needle:
    ...
    run:
        ...
        for filename in os.listdir(needle_f):
            ...
            region = filename.split(".")[0].split("_")[-1]
